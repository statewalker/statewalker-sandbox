...
| | Raw | Gzipped | Build |
|---|---|---|---|
| `pnpm build:css` (this app, at the time of writing) | **9,485 B** | **2,601 B** | ~40 ms |
...
is in scope, prose included — writing this README, which quotes `tracking-tight`
and `flex-col` and `gap-2` in the course of explaining them, moved the bundle from
9,216 B to 9,485 B raw. Any rung added by any other agent moves it again. Quote it
with a date, or do not quote it.
