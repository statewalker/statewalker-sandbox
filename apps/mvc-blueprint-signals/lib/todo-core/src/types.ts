 ...
 * and deliberately not `FilesApi` itself (spec §4.6: a domain noun cannot enter
 ...
 * is a description of the file tree rather than of behaviour — and §4.2's
 * coalescing would stop meaning anything, because it collapses two edges
